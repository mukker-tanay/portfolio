...
SECRET_KEY = 'django-insecure-l)n0-5)!napr!de23emwk4l#7orj!$*j97(w=nu596sj2*ysr3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.5.0.2']
...
# Postgres Configuration (Use Environment Variables for Production)
...
# Email Configuration
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Prints to terminal for dev
